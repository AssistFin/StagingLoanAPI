...
class SendBulkOverdueSmsJob implements ShouldQueue
{
    ...
    public function handle()
    {
        foreach ($this->users as $user) {
            ...
            $text = "Dear User, Repayment of your loan emi of Rs. {$dues} with LoanOne is overdue. Please pay immediately to avoid legal action, penalties and negative credit report. Pay now: {$loginUrl} Regards, LoanOne";
