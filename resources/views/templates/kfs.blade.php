    ...
    <div class="sanction-letter">
        ...
        <table>
            ...
            <tr>
                ...
                <td><span>{{number_format($loan_amount, 2)}}</span></td>
            </tr>
            <tr>
                <td>2.</td>
                <td>Rate of Interest (ROI) per day</td>
                <td><span>{{number_format($rate_of_interest, 2)}}%</span></td>
            </tr>
            <tr>
                <td>3.</td>
                <td>Loan Tenure (days)</td>
                <td><span>{{$loan_tenure}}</span></td>
            </tr>
            <tr>
                <td>4.</td>
                <td>Processing Fee + GST (%)</td>
                <td><span>{{number_format($processingFeeAmount + $ECSGST, 2)}}</span></td>
            </tr>
            <tr>
                <td>5.</td>
                <td>Disbursal Amount (1-4)</td>
                <td><span>{{number_format($disbursal_amount, 2)}}</span></td>
            </tr>
            <tr>
                <td>6.</td>
                <td>Total Repayment Amount</td>
                <td><span>{{number_format($total_repayment_amount, 2)}}</span></td>
            </tr>
            <tr>
                <td>7.</td>
    ...
    <div class="kfs-section">
        ...
        <table>
            ...
            <tr>
                <td>i</td>
                <td>Loan amount</td>
                <td><span style="font-family: DejaVu Sans;">₹ {{number_format($loan_amount, 2) }}</span></td>
            </tr>
            <tr>
                <td>ii</td>
                <td>Total interest charge during the entire tenor of the loan</td>
                <td><span style="font-family: DejaVu Sans;">₹ {{number_format(($totalInterest), 2) }}</span></td>
            </tr>
            <tr>
                <td>iii</td>
                <td>Other up-front Charges</td>
                <td><span style="font-family: DejaVu Sans;">₹ 0.0</span></td>
            </tr>
            <tr>
                <td>a</td>
                <td>Processing fees, if any</td>
                <td><span style="font-family: DejaVu Sans;">₹ {{number_format($processingFeeAmount, 2) }}</span></td>
            </tr>
            <tr>
                <td>b</td>
            ...
            <tr>
                ...
                <td><span style="font-family: DejaVu Sans;">₹ {{number_format($ECSGST, 2) }}</span></td>
            </tr>
            <tr>
                <td>iv</td>
                <td>Net disbursed amount ((i)-(iii))</td>
                <td><span style="font-family: DejaVu Sans;">₹ {{number_format($disbursal_amount, 2) }}</span></td>
            </tr>
            <td>v</td>
            <td>Total amount to be paid by the borrower</td>
            <td><span style="font-family: DejaVu Sans;">₹ {{number_format($total_repayment_amount, 2) }}</span></td>
            </tr>
            <tr>
                <td>vi</td>
        ...
        <ol class="terms-list">
            ...
            <li>*Grievance Redressal Officer:<br>
                Ravi Shankar Kumar<br>
                Grievance Redressal Officer/ Nodal Officer<br>
