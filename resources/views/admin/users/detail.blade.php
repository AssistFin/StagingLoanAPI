...
@section('panel')
        ...
        <div class="col-12">
            <div class="d-flex flex-wrap gap-3">
                ...
                @if ($user->bank_account_number || $user->upi_id)
                    <div class="flex-fill">
                        <a href="{{ route('admin.users.bank.details', $user->id) }}" target="_blank"
                            class="btn btn--dark btn--shadow w-100 btn-lg">
                            <i class="las la-user-check"></i>@lang('Bank Data')
                        </a>
                    </div>
                @endif

                <div class="flex-fill">
                        <a href="{{ route('admin.users.device.data', $user->id) }}" target="_blank"
                            class="btn btn--primary btn--shadow w-100 btn-lg">
                            <i class="las la-user-check"></i>@lang('User Device Data')
                        </a>
                    </div>
    ...
    <div class="form-group">
        ...
        @php
            ...
            $cleanedMobileNumber = ltrim($mobileNumber, '+');
            echo "<script>console.log('Original Mobile Number: " . $mobileNumber . "');</script>";
            echo "<script>console.log('Cleaned Mobile Number: " . $cleanedMobileNumber . "');</script>";
        @endphp
...
@push('script')
    <script>
        ...
        let originalMobileNumber = '{{ $user->mobile }}';

        mobileInput.value = originalMobileNumber;
        console.log('Original Mobile Number:', originalMobileNumber);
