...
<div class="login-main"
    style="background-image: url('{{ asset('assets/admin/images/login-background.jpg') }}')">
                ...
                <div class="login-area">
                    <div class="login-wrapper">
                        <div class="login-wrapper__top">
                            <h3 class="title text-white">@lang('Welcome to') <strong>LoanOne</strong></h3>
                            <p class="text-white">{{ __($pageTitle) }} @lang('to') LoanOne
                                @lang('Dashboard')</p>
                        </div>
